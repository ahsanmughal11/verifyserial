...
<head>
    ...
    <title>Forgot Password - Karachi Bullion Exchange</title>
...
<body class="font-sans bg-[#1a1a1a] text-white min-h-screen flex justify-center items-center relative overflow-hidden before:content-[''] before:absolute before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:w-[800px] before:h-[800px] before:bg-[radial-gradient(circle,rgba(255,215,0,0.1)_0%,rgba(212,175,55,0.05)_30%,transparent_70%)] before:pointer-events-none before:z-0">
    <div class="bg-gradient-to-br from-[#2a2a2a] to-[#1f1f1f] border border-[rgba(255,215,0,0.3)] rounded-sm p-[50px] px-10 w-full max-w-[450px] shadow-[0_8px_20px_rgba(0,0,0,0.4),0_0_0_1px_rgba(255,215,0,0.1)_inset] relative z-10 before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:h-[3px] before:bg-[linear-gradient(90deg,transparent,#ffd700,#d4af37,#ffd700,transparent)] before:opacity-60">
        ...
        <div class="text-center mb-10">
            ...
            <h1 class="text-2xl font-bold text-white mb-2.5 text-center">Forgot Password</h1>
            <p class="text-sm text-[#888] text-center">Enter your email and we'll send you a reset link</p>
        </div>
        ...
        @if(session('status'))
            <div class="text-[#51cf66] mb-5 py-3 px-4 bg-[rgba(81,207,102,0.1)] border border-[rgba(81,207,102,0.3)] rounded-sm text-sm flex items-center gap-2">
        ...
        <form method="POST" action="/forgot-password">
            ...
            <button type="submit" class="w-full py-4 bg-gradient-to-br from-[#d4af37] to-[#ffd700] text-[#1a1a1a] border-none rounded-sm text-base font-bold cursor-pointer transition-all duration-300 mb-5 hover:-translate-y-0.5 hover:shadow-[0_5px_15px_rgba(255,215,0,0.4)]">
                Send Reset Link
            </button>
        </form>

        <div class="text-center mt-5 pt-5 border-t border-[#333]">
            <a href="/login" class="text-[#cccccc] no-underline text-sm inline-flex items-center justify-center gap-2 transition-colors duration-300 hover:text-[#ffd700]">
