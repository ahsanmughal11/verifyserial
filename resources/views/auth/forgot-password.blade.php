...
<head>
    ...
    <title>Forgot Password - Karachi Silver Enterprise</title>
...
<body
    ...
    <div
        ...
        @if(session('status'))
            <div
                class="text-[#51cf66] mb-5 py-3 px-4 bg-[rgba(81,207,102,0.1)] border border-[rgba(81,207,102,0.3)] rounded-sm text-sm flex items-center gap-2">
