...
<head>
    ...
    <title>Privacy Policy - Karachi Silver Enterprise</title>
        ...
        <div
            ...
            <section>
                ...
                <p class="text-[#cccccc] light-mode:text-[#4a4a4a] leading-relaxed mb-4">
                    Karachi Silver Enterprise ("we," "our," or "us") is committed to protecting your privacy. This
                    Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit
                    our website and use our verification services.
                </p>
            ...
            <section>
                ...
                <p class="text-[#cccccc] light-mode:text-[#4a4a4a] leading-relaxed mb-4">We use the information we
                    collect to:</p>
                <ul class="list-disc pl-6 space-y-2 text-[#cccccc] light-mode:text-[#4a4a4a]">
            ...
            <section>
                ...
                <p class="text-[#cccccc] light-mode:text-[#4a4a4a] leading-relaxed">
                    Your data is stored on secure servers and is retained only for as long as necessary to fulfill the
            ...
            <section>
                ...
                <p class="text-[#cccccc] light-mode:text-[#4a4a4a] leading-relaxed mb-4">We do not sell, trade, or rent
                    your personal information to third parties. We may share your information only in the following
                    circumstances:</p>
                <ul class="list-disc pl-6 space-y-2 text-[#cccccc] light-mode:text-[#4a4a4a]">
                    <li>With your explicit consent</li>
                    <li>To comply with legal obligations or court orders</li>
                    <li>To protect our rights, property, or safety</li>
                    <li>With service providers who assist in operating our website (under strict confidentiality
                        agreements)</li>
                </ul>
            </section>
            ...
            <section>
                ...
                <p class="text-[#cccccc] light-mode:text-[#4a4a4a] leading-relaxed mt-4">
                    To exercise these rights, please contact us at <a href="mailto:contact@karachibullionexchange.com"
                        class="text-[#ffd700] hover:underline">contact@karachibullionexchange.com</a>.
                </p>
            </section>
            ...
            <section>
                ...
                <p class="text-[#cccccc] light-mode:text-[#4a4a4a] leading-relaxed mb-4">
                    ...
                    information about our use of cookies, please refer to our <a href="{{ route('legal.cookies') }}"
                        class="text-[#ffd700] hover:underline">Cookies Policy</a>.
                </p>
            </section>
