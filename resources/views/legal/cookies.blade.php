...
<head>
    ...
    <title>Cookies Policy - Karachi Silver Enterprise</title>
    ...
    <div class="max-w-[900px] mx-auto px-10 py-16">
        ...
        <div
            ...
            <section>
                ...
                <p class="text-[#cccccc] light-mode:text-[#4a4a4a] leading-relaxed mb-4">
                    Karachi Silver Enterprise uses cookies for the following purposes:
                </p>
                <ul class="list-disc pl-6 space-y-2 text-[#cccccc] light-mode:text-[#4a4a4a]">
                    <li><strong>Essential Cookies:</strong> Required for the website to function properly, including
                        session management and security</li>
                    <li><strong>Preference Cookies:</strong> Remember your preferences, such as theme selection
                        (dark/light mode)</li>
                    <li><strong>Analytics Cookies:</strong> Help us understand how visitors interact with our website
                    </li>
            ...
            <section>
                ...
                <p class="text-[#cccccc] light-mode:text-[#4a4a4a] leading-relaxed mb-4">
                    ...
                    maintaining your session while using our website, particularly for authentication and security
                    purposes.
                </p>
                ...
                <p class="text-[#cccccc] light-mode:text-[#4a4a4a] leading-relaxed mb-4">
                    These cookies help protect against Cross-Site Request Forgery (CSRF) attacks by storing a unique
            ...
            <section>
                ...
                <p class="text-[#cccccc] light-mode:text-[#4a4a4a] leading-relaxed mb-4">
                    ...
                    statistics of the website and deliver advertisements. These third-party cookies may include:
                </p>
                <ul class="list-disc pl-6 space-y-2 text-[#cccccc] light-mode:text-[#4a4a4a]">
                ...
                <p class="text-[#cccccc] light-mode:text-[#4a4a4a] leading-relaxed mt-4">
                    Please note that we do not currently use third-party advertising or extensive analytics cookies, but
            ...
            <section>
                ...
                <p class="text-[#cccccc] light-mode:text-[#4a4a4a] leading-relaxed mb-4">
                    However, please note that disabling cookies may affect the functionality of our website. Some
                ...
                <ul class="list-disc pl-6 space-y-2 text-[#cccccc] light-mode:text-[#4a4a4a]">
                    ...
                    <li><strong>Edge:</strong> Settings > Privacy, search, and services > Cookies and site permissions
                    </li>
                </ul>
            </section>
            ...
            <section>
                ...
                <p class="text-[#cccccc] light-mode:text-[#4a4a4a] leading-relaxed mb-4">
                    In addition to cookies, we use browser local storage to store certain preferences, such as your
                    theme selection. Local storage is similar to cookies but stored directly in your browser and not
