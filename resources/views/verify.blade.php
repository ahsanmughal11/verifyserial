        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="bg-theme-gradient border border-theme-light rounded-md p-[50px] px-9 text-center transition-all duration-300 relative overflow-hidden shadow-[0_8px_20px_var(--shadow-color)] before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:h-[3px] before:bg-[linear-gradient(90deg,transparent,#ffd700,#d4af37,#ffd700,transparent)] before:opacity-60 before:transition-opacity before:duration-300 hover:-translate-y-2 hover:shadow-[0_12px_30px_rgba(255,215,0,0.3)] hover:border-[rgba(255,215,0,0.6)] hover:before:opacity-100 hover:before:h-1 group">
                <div class="w-[90px] h-[90px] mx-auto mb-6 bg-gradient-to-br from-[rgba(255,215,0,0.15)] to-[rgba(212,175,55,0.08)] border-2 border-[rgba(255,215,0,0.4)] rounded-md flex items-center justify-center transition-all duration-300 shadow-[0_4px_10px_rgba(255,215,0,0.2)] group-hover:bg-gradient-to-br group-hover:from-[rgba(255,215,0,0.25)] group-hover:to-[rgba(212,175,55,0.15)] group-hover:scale-110 group-hover:border-[rgba(255,215,0,0.7)] group-hover:shadow-[0_6px_15px_rgba(255,215,0,0.3)]">
                    <svg class="w-12 h-12 text-[#ffd700] light-mode:text-theme-gold" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                    </svg>
                </div>
                <h3 class="text-[22px] font-bold mb-[18px] text-[#ffd700] light-mode:text-theme-gold tracking-[0.5px]">Purity Standard</h3>
            ...
            <div class="bg-theme-gradient border border-theme-light rounded-md p-[50px] px-9 text-center transition-all duration-300 relative overflow-hidden shadow-[0_8px_20px_var(--shadow-color)] before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:h-[3px] before:bg-[linear-gradient(90deg,transparent,#ffd700,#d4af37,#ffd700,transparent)] before:opacity-60 before:transition-opacity before:duration-300 hover:-translate-y-2 hover:shadow-[0_12px_30px_rgba(255,215,0,0.3)] hover:border-[rgba(255,215,0,0.6)] hover:before:opacity-100 hover:before:h-1 group">
                ...
                <h3 class="text-[22px] font-bold mb-[18px] text-[#ffd700] light-mode:text-theme-gold tracking-[0.5px]">Anti-Counterfeit</h3>
                <p class="text-sm text-theme-secondary leading-[1.8]">
            ...
            <div class="bg-theme-gradient border border-theme-light rounded-md p-[50px] px-9 text-center transition-all duration-300 relative overflow-hidden shadow-[0_8px_20px_var(--shadow-color)] before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:h-[3px] before:bg-[linear-gradient(90deg,transparent,#ffd700,#d4af37,#ffd700,transparent)] before:opacity-60 before:transition-opacity before:duration-300 hover:-translate-y-2 hover:shadow-[0_12px_30px_rgba(255,215,0,0.3)] hover:border-[rgba(255,215,0,0.6)] hover:before:opacity-100 hover:before:h-1 group">
                ...
                <h3 class="text-[22px] font-bold mb-[18px] text-[#ffd700] light-mode:text-theme-gold tracking-[0.5px]">Digital Assay</h3>
                <p class="text-sm text-theme-secondary leading-[1.8]">
