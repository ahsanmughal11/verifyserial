...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <div class="lg:col-span-1 bg-gradient-to-br from-[#1f1f1f] to-[#1a1a1a] border border-[#2a2a2a] rounded-lg p-6">
        ...
        <form method="POST" action="{{ route('admin.blog.tags.store') }}" class="space-y-4">
            ...
            <button type="submit" class="w-full py-3 bg-gradient-to-br from-[#d4af37] to-[#ffd700] text-[#1a1a1a] rounded-md font-semibold">Create Tag</button>
        </form>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="py-3 px-4 border-b border-[#2a2a2a]">
                            <div class="flex gap-2">
                                <a href="{{ route('admin.blog.tags.edit', $tag) }}" class="py-1.5 px-3 border border-[#ffd700] text-[#ffd700] rounded text-xs no-underline">Edit</a>
