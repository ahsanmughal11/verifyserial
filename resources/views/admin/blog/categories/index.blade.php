                    ...
                    <tr class="hover:bg-[rgba(255,215,0,0.05)]">
                        ...
                        <td class="py-3 px-4 border-b border-[#2a2a2a]">
                            <div class="flex gap-2 justify-center">
                                <a href="{{ route('admin.blog.categories.edit', $category) }}" class="tooltip-wrap w-8 h-8 flex items-center justify-center rounded-lg border border-[#2a2a2a] bg-transparent text-[#ffd700] no-underline transition-all duration-200 hover:bg-[#ffd700] hover:text-[#1a1a1a] hover:border-[#ffd700]">
