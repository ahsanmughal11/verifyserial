        ...
        <div
            ...
            <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="mb-6">
                        <x-admin.file-upload name="product_picture" label="Product Picture" accept="image/*"
                            hint="Drag & drop or click. Max 5MB." />
                    ...
                    <div class="mb-6">
                        <x-admin.file-upload name="xrf_image" label="XRF Image" accept="image/*"
                            hint="XRF analysis image. Max 5MB." />
                        @error('xrf_image')
                            <div class="text-[#ff6b6b] mt-2 text-[13px]">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="mb-6">
                        <x-admin.date-picker name="manufacturing_date" label="Manufacturing Date *"
                            :value="old('manufacturing_date')" :showTime="false" />
                    ...
                    <div class="mb-6">
                        ...
                        <div
                            ...
                            <select name="weight_unit" id="weight_unit"
                                ...
                                <option value="tola" {{ old('weight_unit', 'tola') == 'tola' ? 'selected' : '' }}>Tola
                                </option>
                ...
                <div class="flex gap-4 mt-10 pt-6 border-t border-[#2a2a2a]">
                    <button type="submit"
                        class="py-3 px-8 bg-gradient-to-br from-[#d4af37] to-[#ffd700] text-[#1a1a1a] rounded-md text-sm font-bold border-none cursor-pointer hover:opacity-90 transition-opacity">Add
                        Product</button>
                    <a href="{{ route('admin.products.index') }}"
