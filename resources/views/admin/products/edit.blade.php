            ...
            <form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    @if($product->product_picture)
                        <div id="product_picture_current" class="mt-4 p-5 bg-[#151515] border border-[#2a2a2a] rounded-lg">
                    ...
                    <div id="product_picture_preview" class="mt-4 p-5 bg-[#151515] border border-[#2a2a2a] rounded-lg hidden">
                        <p class="text-[#888] text-[13px] mb-4 font-semibold">New Preview:</p>
                ...
                <div class="mb-6">
                    ...
                    @if($product->xrf_image)
                        <div id="xrf_image_current" class="mt-4 p-5 bg-[#151515] border border-[#2a2a2a] rounded-lg">
                            <p class="text-[#888] text-[13px] mb-4 font-semibold">Current XRF Image:</p>
                            <img src="{{ asset($product->xrf_image) }}" alt="XRF Analysis - {{ $product->product_name }}" class="max-w-[250px] rounded-lg border border-[#2a2a2a]">
                        </div>
                    @endif
                ...
                <div class="mb-6">
                    ...
                    <div class="flex gap-3">
                        <input type="number" id="weight" name="weight" value="{{ old('weight', $product->weight) }}" step="0.01" min="0" placeholder="e.g. 1.00" class="flex-1 py-3.5 px-[18px] bg-[#151515] border border-[#2a2a2a] rounded-md text-white text-[15px] outline-none transition-all duration-300 focus:border-[#ffd700] focus:shadow-[0_0_0_3px_rgba(255,215,0,0.1)]">
